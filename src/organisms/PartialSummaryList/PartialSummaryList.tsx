import { Accordion, AccordionDetails, AccordionSummary, Box, Chip, Container, Stack, Step, StepContent, StepLabel, Stepper, Typography } from "@mui/material";
      ...
      <Step active key={summary.title} index={summary.grade - 1}
       >
        ...
        <StepContent>
          ...
          {summary.description && <Typography>
            {summary.description}
          </Typography>}
        </StepContent>
      </Step>
